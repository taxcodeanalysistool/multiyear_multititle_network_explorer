          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="bg-gray-900 border border-gray-600 rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="pl-4 border-l-2 border-blue-500">
                  <div className="font-medium text-white mb-1">Top-Down View</div>
                ...
                <div className="pl-4 border-l-2 border-green-500">
                  <div className="font-medium text-white mb-1">Bottom-Up Search</div>
                  <p className="text-sm text-gray-400">
            ...
            <div className="bg-gray-900 border border-gray-600 rounded-lg p-4">
              ...
              <ul className="list-none space-y-2 text-sm text-gray-300">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Choose a time scope</strong> (year or period) in Graph Settings to view
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Search for nodes</strong> using the search box, or enter keywords in the
                    Search section to build a custom network
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 font-bold">4.</span>
                  <span>
                    <strong>Click any node</strong> in the graph to see its relationships in the right
                    sidebar
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Expand relationships</strong> to view details, or click "View full text"
                    to read the complete section
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-600 rounded-lg p-4">
              ...
              <div className="mt-3 pt-3 border-t border-gray-700 text-xs text-gray-400">
                <strong>Relationship types:</strong> Definition (blue), Reference (green), Hierarchy (purple)
              </div>
            </div>
